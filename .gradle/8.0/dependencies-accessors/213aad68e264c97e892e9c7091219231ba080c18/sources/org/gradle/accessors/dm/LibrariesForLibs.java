...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public MbridgeLibraryAccessors getMbridge() { return laccForMbridgeLibraryAccessors; }
     ...
     */
    public UnityLibraryAccessors getUnity() { return laccForUnityLibraryAccessors; }

    /**
     * Returns the group of libraries at user
     */
    public UserLibraryAccessors getUser() { return laccForUserLibraryAccessors; }
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        public FirebaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() { return create("firebase.core"); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPerf() { return create("firebase.perf"); }
    ...
    public static class MbridgeLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public MbridgeAndroidLibraryAccessors getAndroid() { return laccForMbridgeAndroidLibraryAccessors; }
    ...
    public static class MbridgeAndroidLibraryAccessors extends SubDependencyFactory {
        ...
        public MbridgeAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSdk() { return create("mbridge.android.sdk"); }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public PlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAds() { return create("play.services.ads"); }
    ...
    public static class UnityLibraryAccessors extends SubDependencyFactory {
        ...
        public UnityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAds() { return create("unity.ads"); }
    ...
    public static class UserLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public UserMessagingLibraryAccessors getMessaging() { return laccForUserMessagingLibraryAccessors; }
    ...
    public static class UserMessagingLibraryAccessors extends SubDependencyFactory {
        ...
        public UserMessagingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlatform() { return create("user.messaging.platform"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: perf (1.4.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: sdpAndroid (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: sspAndroid (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: unityAds (4.12.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
         ...
         */
        public MbridgeVersionAccessors getMbridge() { return vaccForMbridgeVersionAccessors; }
    ...
    public static class MbridgeVersionAccessors extends VersionFactory  {
         ...
         */
        public MbridgeAndroidVersionAccessors getAndroid() { return vaccForMbridgeAndroidVersionAccessors; }
    ...
    public static class MbridgeAndroidVersionAccessors extends VersionFactory  {
        ...
        public MbridgeAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: mbridge.android.sdk (16.9.21)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         */
        public AndroidxPluginAccessors getAndroidx() { return paccForAndroidxPluginAccessors; }
    ...
    public static class AndroidxPluginAccessors extends PluginFactory {
         ...
         */
        public AndroidxNavigationPluginAccessors getNavigation() { return paccForAndroidxNavigationPluginAccessors; }
    ...
    public static class ComGoogleFirebasePluginAccessors extends PluginFactory {
        ...
        public ComGoogleFirebasePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for com.google.firebase.perf to the plugin id 'com.google.firebase.firebase-perf'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getPerf() { return createPlugin("com.google.firebase.perf"); }
